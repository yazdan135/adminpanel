...
$sql = "select books .* , authors.author_name, category.category from books inner join authors on authors.id = books.authid_FK inner join category on category.id = books.catld_FK";

                                    ...
                                    <form method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-12">
                                                ...
                                                <input type="text" name="author-name" class="form-control" placeholder="enter Author name">
                                            </div>
                                            <div class="form-group col-md-12">
                                            ...
                                            <div class="form-group col-md-12">
                                                ...
                                                <input type="text" name="location" class="form-control" placeholder="give location">
                                            </div>
                                            <div class="form-group col-md-12">
...
if(isset($_POST['submit'])){
    ...
    $sql = "insert into authors (author_name	, dob ,location , image) values ('$name' , '$dob' , '$location' , '$image')";
